              ...
              if (_doneLoading && _version != null ||
                ...
                HoverMessageWithIconAction(
                  message: SharedPref()
                      ...
                      ? 'Checked for new updates ${getTimeAgo(DateTime.parse(SharedPref().pref.getString(SPConst.lastVSCodeUpdateCheck) ?? DateTime.now().toString()))}'
                ...
                HoverMessageWithIconAction(
                  message: SharedPref()
                      ...
                      ? 'Last updated ${getTimeAgo(DateTime.parse(SharedPref().pref.getString(SPConst.lastVSCodeUpdate) ?? DateTime.now().toString()))}'
