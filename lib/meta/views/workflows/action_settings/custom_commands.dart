              ...
              children: <Widget>[
                ...
                SquareButton(
                  ...
                  onPressed: () {
                    ...
                    widget.onCommandsChanged(
                        _commands.where((_) => _.trim().isNotEmpty).toList());
                  },
                ),
              ],
            ),
...
Widget _getSuffixIcon(String command) {
  String _x = command.toLowerCase().trim();
  if (_x.startsWith('cd')) {
