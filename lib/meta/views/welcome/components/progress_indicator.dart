...
Widget installProgressIndicator({
  ...
  return Consumer<DownloadNotifier>(
    builder: (BuildContext context, DownloadNotifier downloadNotifier, _) {
      double _percent = disabled ? 0 : (downloadNotifier.progress ?? 0) / 100;
                    ...
                    children: <Widget>[
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              progress == Progress.FAILED
                                  ? 'Download Failed'
                                  : '${(_percent * 100).floor()}% • 56 seconds left',
                              style: TextStyle(
                                color: context
                      ...
                      Padding(
                        ...
                        child: LinearProgressIndicator(
                          value: _percent,
                          valueColor:
                              AlwaysStoppedAnimation<Color>(_color(progress)),
                          backgroundColor: _color(progress).withOpacity(0.1),
                          minHeight: 5,
                        ),
                      ),
                    ],
