...
class FlutterProjectPlatformsSection extends StatefulWidget {
  final bool ios;
  final bool android;
  final bool web;
  final bool windows;
  ...
  const FlutterProjectPlatformsSection({
    Key? key,
  ...
  @override
  _FlutterProjectPlatformsSectionState createState() =>
      _FlutterProjectPlatformsSectionState();
}

class _FlutterProjectPlatformsSectionState extends State<FlutterProjectPlatformsSection> {
  @override
