        ...
        child: Column(
          ...
          children: [
            ...
            if (_projectName != null &&
              ...
              _projectWarningWidget('Your project name needs to start with a lower-case English character (a-z).',
                  Assets.error, kRedColor),
            //Checks if there are numbers included in the project name
            if (_projectName != null && _projectName!.contains(RegExp('[0-9]')))
              _projectWarningWidget('You can\'t have any numbers in your project name. Try using characters such as English letters (a-z) and underscores (_).',
                  Assets.error, kRedColor),
            //Checks to see if there are any upper-case letters
            if (_projectName != null && _projectName!.contains(RegExp('[A-Z]')))
              _projectWarningWidget('Any upper-case letters in the project name will be turned to a lower-case letter.',
                  Assets.warning, kYellowColor),
              ...
              child: RoundContainer(
                ...
                child: Row(
                  children: [
                    ...
                    const Expanded(child: Text('Your project name can only include lower-case English letters (a-z) and underscores (_).')),
                  ],
                ),
              ),
            ),
...
Widget _projectWarningWidget(String text, String asset, Color color) => Padding(
      padding: const EdgeInsets.only(top: 10),
      child: RoundContainer(
        borderColor: color,
        radius: 5,
